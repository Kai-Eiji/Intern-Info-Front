...
class ModStudentForm extends React.Component {
  state = {
    id: null,
    company: "",
    salary:  0.0,
  ...
  componentDidMount() {
      this.setState({
        ...
        company: this.props.student.company,
        salary:  this.props.student.salary,
        city: this.props.student.city,
        state: this.props.student.state,
        grade_year: this.props.student.grade_year,
        job_role: this.props.student.job_role,
        prev_exp_num: this.props.student.prev_exp_num,
        prev_exp_det: this.props.student.prev_exp_det,
        university: this.props.student.university,
        gpa: null,
        jobs_applied: "1-10",
        housing: this.props.student.housing,
        housing_amount: this.props.student.housing_amount,
        comment: this.props.student.comment,
        checked: "first",
      })
  }
  ...
  onChangeFloat = e => {
    ...
    modifyStudent = e => {
        e.preventDefault();
        axios.put(List_URL + this.props.student.pk + '/', this.state).then((response) => {
    ...
    return (
      ...
      <Form.Row>
          ...
          <Form.Group controlId="exampleForm.SelectCustom">
            ...
            <Form.Control onChange={this.onChange} value={this.state.grade_year} name="grade_year">
      ...
      <Form.Row>
          <Form.Group as={Col} md="2" controlId="exampleForm.SelectCustom">
            ...
            <Form.Control onChange={this.onChange} value={this.state.job_role} type="text" name="job_role" >
          ...
          <Form.Group as={Col} md="4" className="ml-2" controlId="exampleForm.SelectCustom">
            ...
            <Form.Control onChange={this.onChange} value={this.state.prev_exp_num} type="number" name="prev_exp_num" >
          ...
          <Form.Group as={Col} md="4" className="ml-2" controlId="exampleForm.SelectCustom1">
            ...
            <Form.Control onChange={this.onChange} value={this.state.jobs_applied} name="jobs_applied">
